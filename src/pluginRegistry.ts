...
export const PLUGIN_REGISTRY: PluginDef[] = [
  ...
  // ── Category B — Depth-driven, spatial, volumetric ────────────────
  {
    ...
    description: 'Renders fog density mapped to real metric distances from a DA3 depth map.',
    status: 'planned',
    reactsTo: 'bass',
    params: [],
  },
  ...
  },
  {
    ...
    description: 'Segments the frame into near/mid/far planes and grades each independently.',
    status: 'planned',
    reactsTo: 'mid',
    params: [],
  },
  {
    ...
    description: 'Runs a Sobel edge filter on the depth map to extract geometric outlines.',
    status: 'planned',
    reactsTo: 'high',
    params: [],
  },
  ...
  },
  {
    ...
    description: 'Applies progressive blur above and below a selected horizontal focal plane.',
    status: 'planned',
    reactsTo: 'none',
    params: [],
  },
